...
<?php } ?>
    ...
    if ($evanto || $isDemo) {
      _e('
          ...
          <li>external_scroll_top - Defines the elements where a scroll to top event is sent back to the parent. See above.</li>
          ', 'advanced-iframe');
