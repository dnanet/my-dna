...
class WC_Tranzila_Payment_Gateway extends WC_Payment_Gateway {
	...
	function tgwc_receipt_page( $order ) {
		...
		$iframe = '<iframe src="https://direct.tranzila.com/'.$this->terminal_name.'/iframe.php?sum='.$order_total.'&cy=10&currency=1&email='.$order_email.'&phone='.$order_phone.'&address='.$order_address.'&contact='.$order_contact.'&pdesc=WooCommerce Data: '.$woo_data.'" frameborder="0" width="400" height="650"></iframe>';
